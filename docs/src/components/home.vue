...
<template>
  <section id="hero">
    ...
    <p class="actions">
      <a class="get-started" href="/code-specification/build-specification/rollup/index.html">
        现在开始
        <svg
          class="icon"
  ...
  <section id="special-sponsor">
    ...
    <a href="#">
      <picture>
        ...
        <img alt="Value Online logo" width="36" height="36" src="../../assets/images/jzzx.jpg" />
      </picture>
    </a>
    <span>前端底层构建与架构</span>
  </section>
  ...
  <section id="highlights" class="vt-box-container">
    <div class="vt-box">
      <h2>自动化 与 脚手架</h2>
      <p>构建自动化脚本 集成单元测试，提升开发效率， 可扩展 可定制 开发工具， 覆盖开发全链路</p>
    </div>
    <div class="vt-box">
      <h2>组件库 与 框架工具库</h2>
    ...
    <div class="vt-box">
      <h2>前端规范 与 生态</h2>
      <p>git 开发 提交 规范， 边缘生态， 插件开发， 定制功能， 工程化 代码规范</p>
    </div>
  </section>
